    ...
    <main className="relative min-h-screen flex items-center justify-center bg-gradient-to-r from-blue-600 to-teal-600 text-white overflow-hidden">
      ...
      <div className="text-center relative z-10">
        ...
        <div className="p-6 md:p-12 max-w-3xl mx-auto text-center space-y-4">
          ...
          <button className="mt-10 px-8 py-4 bg-gradient-to-r from-pink-600 to-indigo-600 text-white text-lg font-semibold rounded-full shadow-xl transform transition duration-300 hover:scale-105" onClick={() => setShowForm(true)}>
            Let's Connect
          </button>
        </div>
      </div>
